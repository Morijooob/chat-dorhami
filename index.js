  ...
  async fetch(request) {
    try {
      ...
      if (request.method === "GET" && url.pathname === "/users") {
        const rows = this.ctx.storage.sql.exec("SELECT username, avatar, is_starred, is_blocked, is_crowned, is_diamond FROM users ORDER BY username COLLATE NOCASE").toArray();
