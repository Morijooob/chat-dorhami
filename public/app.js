...
let mode='login',socket=null,me=null,reconnectTimer=null,reconnectAttempts=0,privateUser=null,onlineIds=new Set(),typingTimer=null,remoteTypingTimer=null,onlineUsers=[],lastRenderedDay='';
const AVATARS=['🙂','😎','🤩','😇','🥳','🤠','🧑‍💻','👩‍💻','🦊','🐼','🐯','🐨','🐸','🐵','🐱','🐶','🦁','🐻'];
