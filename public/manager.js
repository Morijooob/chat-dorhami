(() => {
  ...
  function installStyle() {
    ...
    style.textContent = `
      ...
      .voice-message{display:flex;align-items:center;min-width:220px;max-width:100%}
      .voice-message audio{width:min(320px,100%);height:40px}
  ...
  function loadVoiceIntegration() {
    if (document.querySelector('script[data-dorhami-voice-public]')) return;
    const script = document.createElement('script');
    script.src = '/voice-public.js?v=20260905-1';
    script.dataset.dorhamiVoicePublic = '1';
    script.defer = true;
