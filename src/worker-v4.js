...
export class Dorhami extends DurableObject {
  ...
  readHistory(){return this.ctx.storage.sql.exec(`SELECT id,user_id,username,body,created_at FROM messages WHERE room=? ORDER BY id DESC LIMIT 100`,ROOM).toArray().reverse();}
